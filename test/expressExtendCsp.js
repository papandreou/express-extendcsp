  ...
  describe('extending the csp', function () {
    ...
    it('should add to an existing directive, array case', function () {
      ...
      return expect(
        'style-src https:',
        'to come out as',
        'style-src https: somewhereovertherainbow.com'
      );
    });
    ...
    describe('with a broken or irregular existing CSP', function () {
      it('should tolerate a semicolon at the end', function () {
        ...
        return expect(
          'script-src *;',
          'to come out as',
          'script-src *; style-src somewhereovertherainbow.com'
        );
      });
      ...
      it('should tolerate an empty directive when adding to it', function () {
        ...
        return expect(
          'style-src',
          'to come out as',
          'style-src somewhereovertherainbow.com'
        );
      });
    ...
    it('should add a new directive', function () {
      ...
      return expect(
        "connect-src 'self'",
        'to come out as',
        "connect-src 'self'; style-src somewhereovertherainbow.com"
      );
    });
    ...
    it('should take default-src into account when adding a new directive that falls back to default-src', function () {
      ...
      return expect(
        "default-src 'self'",
        'to come out as',
        "default-src 'self'; style-src 'self' somewhereovertherainbow.com"
      );
    });
    ...
    it("should handle a default-src of 'none' when adding a new directive that falls back to default-src", function () {
      ...
      return expect(
        "default-src 'none'",
        'to come out as',
        "default-src 'none'; style-src somewhereovertherainbow.com"
      );
    });
    ...
    it('should disregard default-src when adding a new directive that does not fall back to it per spec', function () {
      ...
      return expect(
        "default-src 'self'",
        'to come out as',
        "default-src 'self'; child-src somewhereovertherainbow.com"
      );
    });
  });
});
